...
def render_welcome(
    *,
    ...
    body = (
        ...
        f'  <tr>\n'
        f'    <td style="padding:16px 20px;">\n'
        f'      <p style="margin:0 0 12px;font-size:13px;font-weight:600;color:#2dd4bf;">Deploy in 60 seconds</p>\n'
        f'      <p style="margin:0 0 4px;font-size:12px;color:#9ca3af;">1. Download Docker Compose files from the verification page</p>\n'
        f'      <p style="margin:0 0 4px;font-size:12px;color:#9ca3af;">2. <span style="font-family:\'Courier New\',monospace;color:#2dd4bf;">docker compose up -d</span></p>\n'
        f'      <p style="margin:0;font-size:12px;color:#9ca3af;">3. Point your AI agents at <span style="font-family:\'Courier New\',monospace;color:#2dd4bf;">http://localhost:8080/v1</span></p>\n'
        f'    </td>\n'
        f'  </tr>\n'
        f'</table>\n'
        + _cta_button(quickstart_url, "Full Quickstart Guide")
