...
| V-08 | Element Web or Cinny renders in `platform-web` for primary user | manual | Out of scope for this PR set. Tracked separately as a `platform-web` task once UX wireframes are signed off. |
