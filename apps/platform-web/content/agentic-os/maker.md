...
- `/dashboard/maker/coach` — coach hub. Lists recent sessions, mode
...
- `/dashboard/maker/coach/[sessionId]` — session view. Streaming
...
- `/dashboard/maker` — Top Blockers widget mounted alongside the
...
- `/dashboard/maker/blockers` — full workshop blockers list, grouped
...
`/dashboard/maker/blockers`. Phase 5's PDF / Specs / References cards
remain in place.
...
**Pages:** new `/dashboard/maker/spec-sheets` (workshop list) +
`/dashboard/maker/references` (library). New Specs tab and References
...
**Pages:** new `/dashboard/maker/tools` (workshop list) +
`/dashboard/maker/tools/[toolId]` (detail with consumables tracker,
