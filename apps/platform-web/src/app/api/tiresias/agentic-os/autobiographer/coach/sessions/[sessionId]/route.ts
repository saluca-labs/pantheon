/**
 * Autobiographer coach — single session get / patch / delete.
 *
 * GET    — fetch session + full transcript.
 * PATCH  — rename title (mode is IMMUTABLE post-create).
 * DELETE — hard delete. Chapter revisions originated by this session
 *          survive with `coach_session_id = NULL` (FK rebind on
 *          0048_autobiographer_phase7 declares ON DELETE SET NULL).
 *
