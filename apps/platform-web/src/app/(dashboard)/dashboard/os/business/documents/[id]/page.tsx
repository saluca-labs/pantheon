        ...
        <div className="flex items-center gap-2">
          {document.status === 'draft' && (
            <form action={sendDocumentAction.bind(null, id, user.userId)}>
              <button
                type="submit"
                className="inline-flex items-center gap-2 rounded-lg bg-[#4361EE] hover:bg-[#3a56d4] text-white text-sm font-medium px-4 py-2"
              >
          ...
          {(document.status === 'signed' || document.status === 'sent') && (
            <a
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-[#2a2d3e] bg-[#1a1d27] hover:bg-[#252836] text-[#94a3b8] hover:text-white text-sm font-medium px-4 py-2"
            >
