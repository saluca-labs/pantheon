/**
 * Research OS — Coach session view.
 *
...
import { getSession } from '@/lib/agentic-os/research/coach/sessions-repo';
import {
  CoachSession,
  type CoachUiMessage,
} from '@/components/agentic-os/research/coach/coach-session';
...
export default async function ResearchCoachSessionPage({ params }: Props) {
