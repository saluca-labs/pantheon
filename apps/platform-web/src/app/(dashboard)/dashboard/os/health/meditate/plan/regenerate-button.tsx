  ...
  return (
    <div className="flex items-center gap-3">
      <button
        ...
        disabled={submitting}
        className="inline-flex items-center gap-1.5 rounded-lg bg-accent hover:bg-accent/90 disabled:opacity-60 text-white text-sm font-medium px-3 py-2 transition"
      >
