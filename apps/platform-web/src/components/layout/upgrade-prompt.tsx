 ...
 *
 * W-G.shell: ported from portal/src/components/UpgradePrompt.tsx with
 * Obsidian Flux tokens swapped for Saluca surface/accent tokens.
 */
    ...
    <div className="flex flex-col items-center justify-center py-16 px-8 rounded-xl border border-border-subtle bg-surface-2 gap-4 text-center">
      ...
      <div className="flex items-center gap-3">
        <a
          ...
          className="px-4 py-2 rounded-lg bg-accent/15 border border-accent/25 text-xs font-bold text-accent hover:bg-accent/25 transition-colors"
        >
          View Pricing
        </a>
        <a
          href="mailto:sales@saluca.com"
          className="px-4 py-2 rounded-lg border border-border-subtle text-xs font-bold text-text-secondary hover:text-text-primary hover:border-border-strong transition-colors"
        >
          Contact Sales
        </a>
      </div>
