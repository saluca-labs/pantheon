  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <label className="block">
          <span className="block text-xs uppercase tracking-wide text-text-secondary mb-1.5">Vendor</span>
          <input
            value={vendor}
        ...
        <label className="block">
          <span className="block text-xs uppercase tracking-wide text-text-secondary mb-1.5">Endpoint hint</span>
          <input
            value={endpointHint}
