  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1 text-[10px] uppercase tracking-wide px-2 py-1 rounded border border-[#2a2d3e] bg-[#0f1117] text-[#94a3b8] hover:text-white transition"
        title="Edit arc"
      >
