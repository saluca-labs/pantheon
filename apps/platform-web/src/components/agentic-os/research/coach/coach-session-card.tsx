/**
 * Research coach — recent-session list item.
 *
 * Renders a single session row in the hub sidebar. Mode pill + scope
 * pill + last-updated stamp. The whole card is a Link.
 *
...
export function CoachSessionCard(props: CoachSessionCardProps) {
  return (
    <Link
      href={`/dashboard/os/research/coach/${props.id}`}
