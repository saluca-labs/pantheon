...
const PRESET_META: Record<Exclude<PresetKey, "custom">, { icon: React.ReactNode; accentClass: string; borderClass: string; glowClass: string; description: string }> = {
  soc: {
    ...
    accentClass: "text-of-primary",
    borderClass: "border-of-primary/30",
  ...
  hybrid: {
    ...
    accentClass: "text-transparent bg-clip-text bg-gradient-to-r from-of-primary to-of-primary",
    ...
    <div className="flex flex-wrap gap-3">
          ...
          <motion.button
            ...
            className={`
              ...
              ${isActive
                ...
                : "border-white/[0.06] bg-of-surface-container-low/50 hover:bg-white/[0.03] hover:border-white/[0.1] hover:-translate-y-0.5"
              }
            `}
            whileTap={{ scale: 0.98 }}
            layout
          >
            ...
            {isActive && (
              <motion.div
                ...
                className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-of-primary flex items-center justify-center shadow-lg shadow-of-primary/30"
              >
                <svg className="w-3 h-3 text-of-background" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
            ...
            <div className="text-left">
              <div className={`text-sm font-medium ${isActive ? "text-foreground" : "text-of-on-surface-variant"} transition-colors duration-200`}>
                {preset.name}
              </div>
              <div className="text-[11px] text-of-outline leading-tight mt-0.5">
                {meta.description}
              </div>
            </div>
          </motion.button>
      ...
      {activePreset === "custom" && (
        ...
        >
          ...
          <svg className="w-5 h-5 text-of-on-surface-variant" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <div className="text-left">
            ...
            <div className="text-[11px] text-of-outline leading-tight mt-0.5">Modified layout</div>
          </div>
        </motion.div>
      )}
    </div>
