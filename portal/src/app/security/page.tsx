...
const architectureItems = [
  {
    ...
    icon: (
      <svg className="h-6 w-6 text-gold-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    <>
      ...
      <main className="min-h-screen pt-24 pb-20">
        ...
        <section className="mx-auto max-w-7xl px-6 lg:px-8 pb-24">
          <h2 className="text-sm font-semibold text-gold-500 uppercase tracking-wider mb-2 text-center">
            Architecture
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {architectureItems.map((item) => (
              <div key={item.label} className="glass-card rounded-xl p-8">
        ...
        <section className="mx-auto max-w-4xl px-6 lg:px-8 pb-24">
          <h2 className="text-sm font-semibold text-teal-500 uppercase tracking-wider mb-2 text-center">
            Compliance
          </h2>
                    ...
                    <div
                      className={`h-3 w-3 rounded-full ${
                        i === 0
                          ...
                          : "bg-navy-600 ring-4 ring-navy-800"
                      }`}
                    />
                  </div>
        ...
        <section className="mx-auto max-w-7xl px-6 lg:px-8 pb-24">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {securityPractices.map((practice) => (
              <div key={practice.title} className="glass-card rounded-xl p-8">
        ...
        >
          ...
          <div className="glass-card rounded-2xl p-8 sm:p-12 glow-gold">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                <svg
                  className="h-5 w-5 text-gold-500 flex-shrink-0 mt-0.5"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={2}
