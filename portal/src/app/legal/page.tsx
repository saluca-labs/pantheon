      ...
      <main className="max-w-5xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-teal-400">1.</span> Who We Are
              </h3>
              <ul className="list-disc pl-6 space-y-2 text-foreground-muted">
                ...
                <li>
                  ...
                  <a href="mailto:privacy@saluca.com" className="text-teal-400 hover:text-teal-300 underline">
                    privacy@saluca.com
                  </a>
                </li>
              </ul>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-teal-400">2.</span> Information We Collect
              </h3>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-teal-400">3.</span> How We Use Your Information
              </h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-teal-400">4.</span> Data Residency and Storage
              </h3>
              ...
              <ul className="list-disc pl-6 space-y-2 text-foreground-muted mt-2">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-teal-400">5.</span> Data Retention
              </h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-teal-400">6.</span> Data Sharing and Disclosure
              </h3>
              ...
              <p className="text-foreground-muted mt-3">
                ...
                <a href="https://tiresias.network/legal/sub-processors" className="text-teal-400 hover:text-teal-300 underline">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-teal-400">7.</span> Cookies and Tracking
              </h3>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-teal-400">8.</span> Your Rights
              </h3>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-teal-400">9.</span> Security
              </h3>
              <p className="text-foreground-muted mb-3">
              ...
              <ul className="list-disc pl-6 space-y-2 text-foreground-muted">
                ...
                <li><span className="text-foreground font-medium">Vulnerability Disclosure:</span> We maintain a responsible disclosure program. Security researchers can report vulnerabilities to{" "}
                  <a href="mailto:security@saluca.com" className="text-teal-400 hover:text-teal-300 underline">
                    security@saluca.com
                  </a>.
                </li>
              </ul>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-teal-400">10.</span> Children&apos;s Privacy
              </h3>
              <p className="text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-teal-400">11.</span> Third-Party Links
              </h3>
              <p className="text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-teal-400">12.</span> Changes to This Policy
              </h3>
              <ul className="list-disc pl-6 space-y-2 text-foreground-muted">
                ...
                <li>The current version of this policy is always available at{" "}
                  <a href="https://tiresias.network/privacy" className="text-teal-400 hover:text-teal-300 underline">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-teal-400">13.</span> Contact Us
              </h3>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="text-foreground-muted">
                    <tr className="border-b border-border">
                      ...
                      <td className="py-2">
                        <a href="mailto:privacy@saluca.com" className="text-teal-400 hover:text-teal-300 underline">privacy@saluca.com</a>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="py-2 pr-4">Security concerns</td>
                      <td className="py-2">
                        <a href="mailto:security@saluca.com" className="text-teal-400 hover:text-teal-300 underline">security@saluca.com</a>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="py-2 pr-4">General inquiries</td>
                      <td className="py-2">
                        <a href="mailto:info@saluca.com" className="text-teal-400 hover:text-teal-300 underline">info@saluca.com</a>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
              ...
              <p className="text-foreground-muted mt-3">
                ...
                <a href="https://edpb.europa.eu/about-edpb/about-edpb/members_en" className="text-teal-400 hover:text-teal-300 underline">
                  edpb.europa.eu
                </a>.
              </p>

              <div className="mt-6 pt-4 border-t border-border text-foreground-subtle text-sm">
        ...
        {activeSection === "terms" && (
          <div className="space-y-8">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">1.</span> Definitions
              </h3>
              <ul className="list-disc pl-6 space-y-2 text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">2.</span> Account Registration and Security
              </h3>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">3.</span> Service Tiers and Features
              </h3>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">4.</span> Fees and Payment
              </h3>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">5.</span> Customer Data and Privacy
              </h3>
              ...
              <p className="text-foreground-muted">
                ...
                <button onClick={() => setActiveSection("privacy")} className="text-teal-400 hover:text-teal-300 underline">
                  Privacy Policy
                </button>.
              </p>
              ...
              <p className="text-foreground-muted">
                ...
                <button onClick={() => setActiveSection("dpa")} className="text-teal-400 hover:text-teal-300 underline">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">6.</span> Intellectual Property
              </h3>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">7.</span> Service Level and Support
              </h3>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">8.</span> Acceptable Use
              </h3>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">9.</span> Confidentiality
              </h3>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">10.</span> Warranties and Disclaimers
              </h3>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">11.</span> Limitation of Liability
              </h3>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">12.</span> Indemnification
              </h3>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">13.</span> Term and Termination
              </h3>
              ...
              <p className="text-foreground-muted">
                ...
                <a href="mailto:support@saluca.com" className="text-teal-400 hover:text-teal-300 underline">support@saluca.com</a>.
              </p>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">14.</span> Dispute Resolution
              </h3>
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">15.</span> General Provisions
              </h3>
              ...
              <p className="text-foreground-muted">
                ...
                <a href="mailto:legal@saluca.com" className="text-teal-400 hover:text-teal-300 underline">legal@saluca.com</a>{" "}
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">16.</span> Contact Information
              </h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                  ...
                  <tbody className="text-foreground-muted">
                    ...
                    <tr className="border-b border-border">
                      ...
                      <td className="py-2">
                        <a href="mailto:enterprise@saluca.com" className="text-teal-400 hover:text-teal-300 underline">enterprise@saluca.com</a>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="py-2 pr-4">Billing</td>
                      <td className="py-2">
                        <a href="mailto:billing@saluca.com" className="text-teal-400 hover:text-teal-300 underline">billing@saluca.com</a>
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        {activeSection === "dpa" && (
          <div className="space-y-8">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">2.</span> Scope and Roles
              </h3>
              <ul className="list-disc pl-6 space-y-2 text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">3.</span> Processing Instructions
              </h3>
              <ul className="list-disc pl-6 space-y-2 text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">4.</span> Confidentiality
              </h3>
              <p className="text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">5.</span> Security Measures
              </h3>
              <p className="text-foreground-muted mb-3">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">6.</span> Sub-Processing
              </h3>
              <ul className="list-disc pl-6 space-y-2 text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">7.</span> Data Subject Rights
              </h3>
              <ul className="list-disc pl-6 space-y-2 text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">8.</span> Security Incident Response
              </h3>
              <ul className="list-disc pl-6 space-y-2 text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">9.</span> Data Transfers
              </h3>
              <ul className="list-disc pl-6 space-y-2 text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">10.</span> Data Protection Impact Assessments
              </h3>
              <p className="text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">11.</span> Audit Rights
              </h3>
              <ul className="list-disc pl-6 space-y-2 text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">12.</span> Data Retention and Deletion
              </h3>
              <ul className="list-disc pl-6 space-y-2 text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">13.</span> Liability
              </h3>
              <p className="text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">14.</span> Term
              </h3>
              <p className="text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">15.</span> Conflict
              </h3>
              <p className="text-foreground-muted">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">
                <span className="text-gold-400">16.</span> Contact
              </h3>
              <p className="text-foreground-muted mb-4">
